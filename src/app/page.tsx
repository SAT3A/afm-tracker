...
export default async function DashboardPage({ searchParams }: PageProps) {
  ...
  const businessOverviewMetrics = {
    ...
    hasDistributionData: aggregated.businessOverview.hasDistributionData,
    dataNotice: aggregated.businessOverview.dataNotice,
    contentEngagement: aggregated.businessOverview.contentEngagement,
    distributionEngagement: aggregated.businessOverview.distributionEngagement,
